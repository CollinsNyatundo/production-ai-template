...
This project is indexed by GitNexus as **production-ai-template** (703 symbols, 1117 relationships, 21 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
