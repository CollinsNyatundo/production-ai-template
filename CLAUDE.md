...
This project is indexed by GitNexus as **production-ai-template** (802 symbols, 1235 relationships, 23 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
